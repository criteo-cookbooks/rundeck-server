...
default['rundeck_server']['jvm']['Dserver.http.port']                = '4440'                            # The HTTP port to use for the server, default "4440"
default['rundeck_server']['jvm']['Dserver.https.port']               = '4443'                            # The HTTPS port to use or the server, default "4443"
